const signatureTemplates = (url, motorCarrierName) => {
  return `
  <!DOCTYPE html>
                                      ...
                                      >
                                        ...
                                        >
                                          <span
                                            ...
                                            "
                                            ><strong
                                              >Hi ${motorCarrierName}, Thank you for signing up, please add your signature.</strong
                                            ></span
                                          >
                                        </p>
                                      </div>
                                        ...
                                        >
                                          <span
                                            style="
                                              ...
                                              font-size: 15px;
                                            "
                                            >You're almost done. Please sign to create a new account
                                        ...
                                        >
                                          <span
                                            style="
                                              ...
                                              font-size: 15px;
                                            "
                                            >Confirming your Signature helps
